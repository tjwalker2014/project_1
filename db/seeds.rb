...
course2 = Course.create(name: "User Experience Design Immersive", description: "blah blah blah", campus_id: campus1.id, room_id: londonroom2.id, start_details: DateTime.new(2015, 1, 5), end_details: DateTime.new(2015, 4, 5))
course3 = Course.create(name: "Product Management", description: "blah blah blah", campus_id: campus1.id, room_id: londonroom3.id, start_details: DateTime.new(2015, 1, 5), end_details: DateTime.new(2015, 1, 5))
